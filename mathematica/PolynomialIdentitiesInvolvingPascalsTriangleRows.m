...
PolynomialIdentity2::usage= "Verifies the polynomial identity \sum_{k=0}^{n} \sum_{j=0}^{k} \binom{n}{k} \binom{k}{j} (-1)^{k} m^{k-j}."
PolynomialIdentity3::usage= "Verifies the polynomial identity = \sum_{k=0}^{n} \sum_{j=0}^{k} \binom{n}{j} \binom{n-j}{k-j} (-1)^{k} m^{k-j}."
