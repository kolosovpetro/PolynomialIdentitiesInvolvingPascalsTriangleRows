...
\title[Pascal's triangle and volume of hypercubes]
{Pascal's triangle and volume of hypercubes}
...
\date{\today}
\hypersetup{
    pdftitle={Pascal's triangle and volume of hypercubes},
    pdfsubject={
        Binomial coefficients, Binomial theorem, Pascal's triangle, Binomial sums, Binomial distribution, Binomial identities
    },
...
\begin{document}
    ...
    \bibliography{PascalsTriangleAndVolumeOfHypercubes}
