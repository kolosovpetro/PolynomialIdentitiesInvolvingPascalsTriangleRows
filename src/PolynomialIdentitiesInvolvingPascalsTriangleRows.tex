...
\title[Few polynomial identities involving Pascal's triangle rows]
{Few polynomial identities involving Pascal's triangle rows}
...
\date{\today}
\hypersetup{
    pdftitle={Few polynomial identities involving Pascal's triangle rows},
    pdfsubject={
        Binomial coefficients, Binomial theorem, Pascal's triangle, Binomial sums, Binomial distribution, Binomial identities
    },
